...
internal class KnowledgeService
{
    ...
    private readonly Common.CacheService? _cacheService;
    private readonly ILogger _logger;

    public KnowledgeService(
        HttpClient httpClient, 
        Common.CacheService? cacheService,
        ILogger logger)
    {
    ...
    /// </summary>
    public async Task<Knowledge?> GetAsync(string knowledgeName, string agentName, string tenantId)
    {
        // Validate inputs
        ...
        var cached = _cacheService?.GetKnowledge<Knowledge>(cacheKey);
        if (cached != null)
        {
            _logger.LogDebug(
    ...
    /// </summary>
    public async Task<List<Knowledge>> ListAsync(string agentName, string tenantId)
    {
        // Validate inputs
        ValidateInput(agentName, nameof(agentName));
