...
public class KnowledgeActivities
{
    ...
    private static Common.CacheService? _staticCacheService;
    ...
    /// </summary>
    public KnowledgeActivities(HttpClient? httpClient, Common.CacheService? cacheService = null)
    {
    ...
    /// </summary>
    public static Common.CacheService? GetStaticCacheService()
    {
    ...
    /// </summary>
    private Agents.KnowledgeService CreateKnowledgeService()
    {
        if (_staticHttpClient == null)
        {
        ...
        var logger = Common.LoggerFactory.CreateLogger<Agents.KnowledgeService>();
        return new Agents.KnowledgeService(_staticHttpClient, _staticCacheService, logger);
    }
